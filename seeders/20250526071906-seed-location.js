module.exports = {
  async up({ context }) {
    ...
    try {
      await queryInterface.bulkInsert({tableName:'State',schema}, [
        {
      ...
      await queryInterface.bulkInsert({tableName:'District',schema}, [
        {
      ...
      await queryInterface.bulkInsert({tableName:'City',schema}, [
        {
  ...
  async down({ context }) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.bulkDelete({tableName:'City',schema}, null, {transaction});
      await queryInterface.bulkDelete({tableName:'District',schema}, null, {transaction});
      await queryInterface.bulkDelete({tableName:'State',schema}, null, {transaction});
      await transaction.commit();
    } catch (error) {
      console.log(error);
      console.log('..........Rolling Back Transaction..........');
