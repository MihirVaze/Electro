module.exports = {
  async up({ context }) {
    ...
    try {
      //STATE
      await queryInterface.createTable({tableName:'State',schema}, {
        id: {
          type: Sequelize.UUID,
      ...
      // DISTRICT
      await queryInterface.createTable({tableName:'District',schema}, {
        id: {
          type: Sequelize.UUID,
          defaultValue: Sequelize.UUIDV4,
          primaryKey: true
      ...
      // CITY
      await queryInterface.createTable({tableName:'City',schema}, {
        id: {
          type: Sequelize.UUID,
          defaultValue: Sequelize.UUIDV4,
          primaryKey: true
