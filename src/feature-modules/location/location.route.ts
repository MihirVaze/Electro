...
router.del('/state/:id',   [async(req,res,next)=>{
    try {
...
router.patch('/district/:id',   [async(req,res,next)=>{
    try {
...
router.del('/district/:id',   [async(req,res,next)=>{
    try {
...
router.del('/city/:id',   [async(req,res,next)=>{
    try {
